...
--Com esta outra querie, vocÍ identifica o endereÁo IP de uma sess„o SQL*Plus cliente:
SELECT SYS_CONTEXT('USERENV', 'IP_ADDRESS') FROM DUAL;
--Esta querie acima ir· retornar NULL, caso a sess„o n„o esteja usando TCP/IP na conex„o.

--VocÍ tambÈm pode ter uma vis„o geral de todas as sessıes de banco existentes:
...
begin
  return translate(
         texto,
         '—¡…Õ”⁄¿»Ã“Ÿ¬ Œ‘€√’ƒÀœ÷‹«Ò·ÈÌÛ˙‡ËÏÚ˘‚ÍÓÙ˚„ı‰ÎÔˆ¸Á.-!"''`#$%().:[/]{}®+?;∫™∞ß&¥*<>',
...
-- R" de "Referential", ou seja, È uma CONSTRAINT do tipo FK !
